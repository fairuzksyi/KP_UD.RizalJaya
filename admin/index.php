    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">UD RIZAL JAYA</a> 
            </div>
...
font-size: 16px;"><a href="index.php?halaman=tambahadmin" class="btn btn-primary square-btn-adjust">Daftar Admin</a> </div> -->
        ...
        <div id="page-wrapper" >
            ...
            if (isset($_GET['halaman']))
            {
                ...
                else if($_GET['halaman']=="terima_requestpelanggan")
                {
                    include 'halaman/terima_requestpelanggan.php';
                }
                else if($_GET['halaman']=="hapus_requestpelanggan")
                {
                    include 'halaman/hapus_requestpelanggan.php';
                }
                ...
                else if($_GET['halaman']=="tolak_pesanan")
                {
                    include 'halaman/status_order/tolak_pesanan.php';
                }
                else if($_GET['halaman']=="pembayaran_diterima")
                {
                    include 'halaman/status_order/pembayaran_diterima.php';
                }
                else if($_GET['halaman']=="pesanan_pending")
                {
                    include 'halaman/status_order/pesanan_pending.php';
                }
                else if($_GET['halaman']=="pesanan_dikirim")
                {
                    include 'halaman/status_order/pesanan_dikirim.php';
                }
            }
            else
            {
